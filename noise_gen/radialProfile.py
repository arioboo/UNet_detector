...
A helper function to create the azimuthally averaged 1D radial profile from a 2D image. Right now the code is very crude (calculates the center of the image itself, assumes a bin size of 1, etc.).
But as I (or other people) improve the code, I will keep the version below updated. Dependencies include
